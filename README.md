...
| **Оценка качества** | 10 тест-кейсов с эталонами, проверка галлюцинаций, метрики recall/faithfulness |
...
### Чат с юридическими документами
![Чат](Image/01_chat.png)

### Ответ с источниками
![Ответ с источниками](Image/02_chat_answer.png)

### Извлечение сущностей
![Сущности](Image/04_entities.png)

### Оценка качества (9/10)
![Оценка](Image/07_eval_results.png)
